...
mscodes = ["atom","code","vscodium"]
codeStr = "|".join(str(x) for x in mscodes)

allApps = terminals + browsers + mscodes

#BSPWM
define_keymap(None,{
    K("C-Enter"): launch(["konsole"]),
    K("C-m"): launch(["bspc", "desktop", "-l", "next"]),
    K("C-Left"): launch(["bspc", "node", "-f", "west"]),
    K("C-Right"): launch(["bspc", "node", "-f", "east"]),
    K("C-Up"): launch(["bspc", "node", "-f", "north"]),
    K("C-Down"): launch(["bspc", "node", "-f", "south"]),
    K("C-Shift-Left"): launch(["bspc", "node", "-s", "west"]),
    K("C-Shift-Right"): launch(["bspc", "node", "-s", "east"]),
    K("C-Shift-Up"): launch(["bspc", "node", "-s", "north"]),
    K("C-Shift-Down"): launch(["bspc", "node", "-s", "south"]),
    K("LC-Left"): launch(["bspc", "desktop", "-f", "prev.local"]),
    K("Super-Left"): launch(["bspc", "desktop", "-f", "prev.local"]),
    K("LC-Right"): launch(["bspc", "desktop", "-f", "next.local"]),
    K("Super-Right"): launch(["bspc", "desktop", "-f", "next.local"]),
    K("LC-Key_1"): launch(["bspc", "desktop", "-f", '^1']),
    K("LC-Key_2"): launch(["bspc", "desktop", "-f", "^2"]),
    K("LC-Key_3"): launch(["bspc", "desktop", "-f", "^3"]),
    K("LC-Key_4"): launch(["bspc", "desktop", "-f", "^4"]),
    K("LC-Key_5"): launch(["bspc", "desktop", "-f", "^5"]),
    K("LC-Key_6"): launch(["bspc", "desktop", "-f", "^6"]),
    K("LC-Key_7"): launch(["bspc", "desktop", "-f", "^7"]),
    K("LC-Key_8"): launch(["bspc", "desktop", "-f", "^8"]),
    K("LC-Key_9"): launch(["bspc", "desktop", "-f", "^9"]),
    K("LC-Key_0"): launch(["bspc", "desktop", "-f", "^10"]),
    })

define_keymap(lambda wm_class: wm_class.casefold() not in allApps,{
    K("C-w"): launch(["bspc", "node", "-c"]),
    K("C-q"): launch(["bspc", "node", "-k"]),
})
